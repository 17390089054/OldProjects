...
%>
<h2 style="text-align:center;color:purple;font-size:30px">日 报 管 理</h2>
    ...
    %>
        ...
        <td><%=list.get(i).get("user_name") %></td>
         ...
         %>
          ...
          <%} %>
          <%if(operation==0){ %>
          <a href="ReportCheck?id=<%=list.get(i).get("report_id") %>" name="content" style="text-decoration:none">审  &nbsp; &nbsp;批</a>
          <%} %>
          </td>
    </tr>        
 <%} %>
