...
{
%>
<h2 style="color:purple;font-size:30px;text-align:center">报 销 历 史</h2>
<%
...
<table class="bordered">
    ...
    <tr>
        ...
        {
        	if(list.get(i).get("p_status").equals("2"))
        	{
        		out.write("不 通 过 ");
        	}
        	else
        ...
        if(status==1){
        %>
        <a href="PaymentRevise?id=<%=list.get(i).get("p_id") %>" name="content" style="color:orange;text-decoration:none">辑 &nbsp; &nbsp; &nbsp; &nbsp;辑</a>
        <%} %>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	{
	out.write("<div align='center'>没有报销记录,<a href='AddPayment' style='text-decoration:none;font-size:20px;'>点击添加</a></div>");
	}
