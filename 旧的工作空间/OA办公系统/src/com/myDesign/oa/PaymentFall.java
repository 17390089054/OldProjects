...
@WebServlet("/PaymentFall")
public class PaymentFall extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	 ...
	 String  sql="update payment set p_money='"+money+"',p_status=2 where p_id='"+id+"'";
